...
class MaskedTextController extends TextEditingController {
  static MaskedTextController get phoneMask =>
  ...
  String _applyMask(String mask, String value) {
    ...
    } else if (value.startsWith("+78")) {
      value = value.replaceFirst("+78", "+7");
    } else if (value.startsWith("+8")) {
      value = value.replaceFirst("+8", "+7");
    } else if (value.startsWith("+7+7")) {
      value = value.replaceFirst("+7+7", "+7");
    }
    var maskCharIndex = 0;
